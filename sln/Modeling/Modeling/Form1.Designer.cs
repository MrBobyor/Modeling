namespace Modeling
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.button1.Text = "Эксперимент 1";
            ...
            this.label1.Text = " В очереди к кассе стоят N >> 1 человек. Сумма, которую нужно заплатить отдельном" +
    "у лицу, есть случайная величина со средним  m и дисперсией  d.";
            // 
            // label2
            // 
            ...
            this.label2.Text = " Скорость соударения молекул — случайная величина, распределённая по закону Релея" +
    " с параметром σ.";
            // 
            // Form1
            // 
